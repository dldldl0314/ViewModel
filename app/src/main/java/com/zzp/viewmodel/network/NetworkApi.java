package com.zzp.viewmodel.network;

import com.zzp.viewmodel.network.errorhandler.ExceptionHandle;
import com.zzp.viewmodel.network.errorhandler.HttpErrorHandler;
import com.zzp.viewmodel.network.interceptor.RequestInterceptor;
import com.zzp.viewmodel.network.interceptor.ResponseInterceptor;
...
public class NetworkApi {
     ...
     * @return Observable
     */
    public static <T> ObservableTransformer<T, T> applySchedulers(final Observer observer) {
        return upstream -> {
            ...
            //订阅观察者
            observable.subscribe((io.reactivex.Observer) observer);
            return observable;
        };
    }
